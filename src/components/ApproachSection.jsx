    ...
    <section className="approach-section" id="approach">
      <div className="container">
        <div className="reveal">
          ...
          <h2 className="section-title">Your Child Already Knows. We Help Them Show It.</h2>
          <p className="section-desc">We don't start with vocabulary lists or drills. We start with what your child already knows and help them say it clearly in English.</p>
        </div>
        <div className="approach-grid">
          <div className="approach-card reveal">
            ...
            <h3>Your Child Knows More Than They Can Say</h3>
          ...
          <div className="approach-card reveal reveal-delay-2">
            ...
            <p>Your child doesn't build confidence in a workbook. They build it by speaking — in every lesson, from day one.</p>
          </div>
        </div>
      </div>
    </section>
