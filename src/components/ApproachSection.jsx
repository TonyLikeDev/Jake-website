    ...
    <section className="approach-section" id="approach">
      <div className="container">
        <div className="reveal">
          ...
          <h2 className="section-title">You Already Know More Than You Can Express. We Help You Show It.</h2>
          <p className="section-desc">We don't start with vocabulary lists or drills. We start with what you already know and help you say it clearly in English.</p>
        </div>
        <div className="approach-grid">
          <div className="approach-card reveal">
            ...
            <h3>People Know More Than They Can Say</h3>
            <p>They have ideas and opinions. They just need help getting them out in English.</p>
          </div>
          <div className="approach-card reveal reveal-delay-1">
            ...
            <p>We focus on full sentences first. The right answer comes second.</p>
          </div>
          <div className="approach-card reveal reveal-delay-2">
            ...
            <p>Confidence is built by speaking - in every session, from day one.</p>
          </div>
        </div>
      </div>
    </section>
