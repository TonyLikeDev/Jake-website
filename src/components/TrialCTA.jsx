    ...
    <section className="trial-cta-section" id="trial">
      <div className="container">
        <div className="trial-cta-content reveal">
          ...
          <h2 className="section-title">Request a Trial Appointment</h2>
          <p className="section-desc" style={{ maxWidth: 600 }}>Your trial lesson is more than a free sample—it's a level assessment. We'll evaluate where the student is, identify strengths, and recommend the right program and placement.</p>
