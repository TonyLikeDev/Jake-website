    ...
    <section className="hero" id="hero">
      <div className="container">
        <div className="hero-content">
          ...
          <p className="hero-sub reveal reveal-delay-2">Most just haven&apos;t been taught how to communicate it clearly in English.</p>
          <p className="hero-support reveal reveal-delay-2">The problem isn&apos;t understanding — it&apos;s expression.</p>
